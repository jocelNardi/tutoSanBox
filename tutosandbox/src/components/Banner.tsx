          ...
          <TrackVisibility>
            {({ isVisible }) =>
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <h1>{`Hi! I'm JOCEL`} <span className="txt-rotate" data-rotate='[ "Web Developer", "Web Designer", "Team Leder" ]'><span className="wrap">{text}</span></span></h1>
                <p>My fullname is JOCEL Nardi. I'm 25 years old. I study 249-school in 10th grade.I am a front-end web developer. I can make the website more, more interactive with web animation
